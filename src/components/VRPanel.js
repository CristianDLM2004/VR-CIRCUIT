...
export function createVRPanel({
  ...
  // Panel más ancho para acomodar 4 columnas
  ...
  function createIcon(type) {
    ...
    if (type === "battery") {
      ...
      // Icono: base cuadrada + caperuza roja encima
      ...
      // Icono: base rectangular + palanca inclinada verde
  ...
  // Fila superior: batería, LED, resistencia, botón
  // Fila inferior: switch, cable, guardar, cargar
  // ---------------------------
  ...
  makeButton({ name: "BtnWire",     x: colX[1], y: rowY[1], color: 0x95a5a6, action: "wire",     iconType: "wire"     })
